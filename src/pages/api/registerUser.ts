...
async function createUser(res: NextApiResponse, user: IUser) {
...
async function sendEmail(user: IUser, license: string) {
...
export default async function handler(
  ...
  if (req.method === "POST") {
    ...
    const user: IUser = {
      ...
      cart_token: bodyData.resource.cart_token,
    };
